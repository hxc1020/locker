...
- given：director管理两个manager，manager1管理一个locker1和一个robot1，robot1管理一个locker2，locker1和locker2的可用容量和容量分别为：2，3；1，2，manager2管理一个locker3，locker3的可用容量和容量分别为：0，2，manager2没有管理robot  
when：director获取报表  
then：报表内容为：  
```
M  3  5  
